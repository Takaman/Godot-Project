...
var target_positions = [Vector2(121,-78),Vector2(232,-78)]  # Replace with your desired target positions
...
@onready var animatedSprite := $"/root/FoodCourt/Movablecharacter/greyhatguy"
