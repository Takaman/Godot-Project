...
var target_positions = [Vector2(-205, -203),Vector2(-110, -131),Vector2(-112, -42),Vector2(-99, 54),   Vector2(-110, -131),Vector2(-29, -186),  Vector2(-110, -131)]  # Replace with your desired target positions
...
@onready var animatedSprite := $"/root/Office1/Movablecharacter/yellowhairgirl"
